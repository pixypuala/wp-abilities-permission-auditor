...
|---|---|---|
| v0.1 | inventory and metadata rules | All milestone acceptance and audit gates |
| v0.2 | role matrix and reports | All milestone acceptance and audit gates |
| v0.3 | safe runtime probes/policy diff | All milestone acceptance and audit gates |
| v0.4 | MCP adapter exposure review | All milestone acceptance and audit gates |
| v1.0 | stable rule/finding schema | All milestone acceptance and audit gates |
