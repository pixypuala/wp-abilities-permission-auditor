...
- WordPress 6.9 minimum, current stable and next beta scheduled
- PHP project policy versions
- single site and multisite smoke
- REST enabled and restricted environments
- standard and custom roles
- MCP adapter absent/present versions
- passive and isolated active modes
